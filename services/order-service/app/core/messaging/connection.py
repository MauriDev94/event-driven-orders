...
class RabbitMQConnection:
    ...
    Infrastructure detail only. Use cases never see this class — they
    depend on the ``EventPublisher`` port. The publisher implementation and
    the consumers are the ones that borrow this connection's channel.
    """
